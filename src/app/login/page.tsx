    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 p-5">
      <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white p-7 shadow-2xl md:p-9">
        <div className="mb-8 text-center">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-slate-950 text-2xl font-black text-amber-400">
            ت
          </div>
        ...
        <form onSubmit={submit} className="space-y-4">
          <label className="block">
            ...
            <input
              ...
              required
              className="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-left outline-none transition focus:border-amber-400 focus:ring-4 focus:ring-amber-100"
              dir="ltr"
            />
          </label>
          ...
          <button
            disabled={loading}
            className="w-full rounded-2xl bg-slate-950 px-4 py-4 text-sm font-black text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
